...
interface ProbationFormStatisticsProps {
  data: ProbationFormData
}

export function ProbationFormStatistics({ data }: ProbationFormStatisticsProps) {
  return (
    <Card>
      <CardHeader className="border-b border-border/60 bg-gradient-to-r from-muted/70 via-muted/40 to-transparent dark:from-muted/40 dark:via-muted/20 dark:to-transparent">
        <CardTitle className="text-xl font-semibold text-slate-900 dark:text-white">Probation Form Statistics</CardTitle>
      </CardHeader>
