...
interface AcademicWarningFormStatisticsProps {
  data: {
...
export function AcademicWarningFormStatistics({ data }: AcademicWarningFormStatisticsProps) {
  const chartData = [
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Academic Warning Form Statistics</CardTitle>
        <CardDescription>Academic warning form signing status</CardDescription>
      </CardHeader>
      <CardContent>
