      ...
      <div className="container">
        <div className="mx-auto max-w-6xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold tracking-tight sm:text-4xl mb-4">See SASO System in Action</h2>
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              Experience how SASO System transforms student success through intelligent analytics and coordinated support.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-start">
            <Card className="p-8">
              <div className="aspect-video rounded-lg bg-muted/50 flex items-center justify-center mb-6 relative overflow-hidden">
                <img src="/video-player-interface-showing-educational-analyti.jpg" alt="SASO System Demo Video" className="w-full h-full object-cover" />
              ...
              <p className="text-muted-foreground">
                Watch how educators use SASO System to identify at-risk students, coordinate interventions, and track success
