...
export default function CreateSchedule() {
  ...
  const [events, setEvents] = useState([
    { week: 1, type: "Classes", startDate: "", endDate: "", description: "", highlights: "", extendedInfo: "" }
  ])
  ...
  const onSubmit = (data: z.infer<typeof formSchema>) => {
    // Here we would normally make an API call to save the schedule
    console.log(data)
  ...
  return (
    <div className="flex flex-1 flex-col gap-8 p-8 pt-6 bg-gradient-to-br from-slate-50 via-white to-purple-50/30 dark:from-slate-900 dark:via-slate-900 dark:to-slate-800">
      <PageHeader
        ...
        description="Create a new semester schedule"
      />
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Enter the basic information for the schedule
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...form}>
